    ...
    public class MigrationWorker
    {
        ...
        private async Task EnsureSeedData(AppointmentDbContext dbContext, CancellationToken cancellationToken)
        {
            ...
            var meets = new List<Meet>
            {
                new()
                {
                    EmployeeId = moroz.Id, PatientId = 1, SkillIds = [skillCaries.Id],
                ...
                new()
                {
                    EmployeeId = moroz.Id, PatientId = 2, SkillIds = [skillCleaning.Id],
